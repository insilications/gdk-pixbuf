...
Source0  : https://download.gnome.org/sources/gdk-pixbuf/2.36/gdk-pixbuf-2.36.9.tar.xz
...
%prep
%setup -q -n gdk-pixbuf-2.36.9
pushd ..
cp -a gdk-pixbuf-2.36.9 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1503677633
export AR=gcc-ar
...
/usr/lib64/libgdk_pixbuf-2.0.so.0.3609.0
/usr/lib64/libgdk_pixbuf_xlib-2.0.so.0
/usr/lib64/libgdk_pixbuf_xlib-2.0.so.0.3609.0
...
/usr/lib32/libgdk_pixbuf-2.0.so.0.3609.0
/usr/lib32/libgdk_pixbuf_xlib-2.0.so.0
/usr/lib32/libgdk_pixbuf_xlib-2.0.so.0.3609.0
