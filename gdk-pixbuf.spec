...
Source0  : https://download.gnome.org/sources/gdk-pixbuf/2.36/gdk-pixbuf-2.36.8.tar.xz
...
%prep
%setup -q -n gdk-pixbuf-2.36.8
pushd ..
cp -a gdk-pixbuf-2.36.8 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1503069922
export AR=gcc-ar
...
/usr/lib64/libgdk_pixbuf-2.0.so.0.3608.0
/usr/lib64/libgdk_pixbuf_xlib-2.0.so.0
/usr/lib64/libgdk_pixbuf_xlib-2.0.so.0.3608.0
...
/usr/lib32/libgdk_pixbuf-2.0.so.0.3608.0
/usr/lib32/libgdk_pixbuf_xlib-2.0.so.0
/usr/lib32/libgdk_pixbuf_xlib-2.0.so.0.3608.0
