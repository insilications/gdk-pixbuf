...
Source0  : https://download.gnome.org/sources/gdk-pixbuf/2.42/gdk-pixbuf-2.42.2.tar.xz
...
%prep
%setup -q -n gdk-pixbuf-2.42.2
cd %{_builddir}/gdk-pixbuf-2.42.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607487252
...
cp %{_builddir}/gdk-pixbuf-2.42.2/COPYING %{buildroot}/usr/share/package-licenses/gdk-pixbuf/01a6b4bf79aca9b556822601186afab86e8c4fbf
...
/usr/lib64/libgdk_pixbuf-2.0.so.0.4200.2
