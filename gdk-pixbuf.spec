...
Source0  : https://download.gnome.org/sources/gdk-pixbuf/2.36/gdk-pixbuf-2.36.7.tar.xz
...
%prep
%setup -q -n gdk-pixbuf-2.36.7
%patch1 -p1
pushd ..
cp -a gdk-pixbuf-2.36.7 build32
popd
...
export LANG=C
export SOURCE_DATE_EPOCH=1500407083
export AR=gcc-ar
...
/usr/lib64/libgdk_pixbuf-2.0.so.0.3600.7
/usr/lib64/libgdk_pixbuf_xlib-2.0.so.0
/usr/lib64/libgdk_pixbuf_xlib-2.0.so.0.3600.7
...
/usr/lib32/libgdk_pixbuf-2.0.so.0.3600.7
/usr/lib32/libgdk_pixbuf_xlib-2.0.so.0
/usr/lib32/libgdk_pixbuf_xlib-2.0.so.0.3600.7
