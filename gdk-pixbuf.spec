...
Source0  : https://download.gnome.org/sources/gdk-pixbuf/2.38/gdk-pixbuf-2.38.2.tar.xz
...
%prep
%setup -q -n gdk-pixbuf-2.38.2
%patch1 -p1
pushd ..
cp -a gdk-pixbuf-2.38.2 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1568063153
...
/usr/lib64/libgdk_pixbuf-2.0.so.0.3800.2
/usr/lib64/libgdk_pixbuf_xlib-2.0.so.0
/usr/lib64/libgdk_pixbuf_xlib-2.0.so.0.3800.2
...
/usr/lib32/libgdk_pixbuf-2.0.so.0.3800.2
/usr/lib32/libgdk_pixbuf_xlib-2.0.so.0
/usr/lib32/libgdk_pixbuf_xlib-2.0.so.0.3800.2
