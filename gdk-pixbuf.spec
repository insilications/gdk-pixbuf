...
Version  : 2.36.2
Release  : 27
URL      : http://ftp.gnome.org/pub/GNOME/sources/gdk-pixbuf/2.36/gdk-pixbuf-2.36.2.tar.xz
Source0  : http://ftp.gnome.org/pub/GNOME/sources/gdk-pixbuf/2.36/gdk-pixbuf-2.36.2.tar.xz
...
%prep
%setup -q -n gdk-pixbuf-2.36.2
pushd ..
cp -a gdk-pixbuf-2.36.2 build32
popd
...
/usr/lib64/libgdk_pixbuf-2.0.so.0.3602.0
/usr/lib64/libgdk_pixbuf_xlib-2.0.so.0
/usr/lib64/libgdk_pixbuf_xlib-2.0.so.0.3602.0

%files lib32
%defattr(-,root,root,-)
/usr/lib32/libgdk_pixbuf-2.0.so.0
/usr/lib32/libgdk_pixbuf-2.0.so.0.3602.0
/usr/lib32/libgdk_pixbuf_xlib-2.0.so.0
/usr/lib32/libgdk_pixbuf_xlib-2.0.so.0.3602.0
